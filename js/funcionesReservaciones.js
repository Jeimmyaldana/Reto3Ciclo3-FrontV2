...
function getReservaciones (){
    $.ajax({
        url:"http://192.9.238.217:8080/api/Reservation/all",
        type:"GET",
        datatype:"JSON",
...
function postReservaciones(){
    ...
    $.ajax({
        url:"http://192.9.238.217:8080/api/Reservation/save",
        type:"POST",
        datatype:"JSON",
...
function putReservaciones(idDesdeBoton){
    ...
    $.ajax({
        url:"http://192.9.238.217:8080/api/Reservation/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteReservaciones(data){
    ...
    $.ajax({
        url:"http://192.9.238.217:8080/api/Reservation/"+data,
        type:"DELETE",
        datatype:"JSON",
